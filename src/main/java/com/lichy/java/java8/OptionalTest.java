...
public class OptionalTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(empty.orElse("没有值"));
        System.out.println(name.orElse("没有值"));

        //orElseGet与orElse类似，区别在于传入的默认值。
        //orElseGet接受lambda表达式生成默认值。
        System.out.println(empty.orElseGet(() -> "默认值"));
        System.out.println(name.orElseGet(() -> "默认值"));
        ...
        System.out.println(upperName.orElse("没有值"));
        ...
        System.out.println(shortName.orElse("长度小于6"));
